...
namespace AgileBits
{
	...
	//{
	//	// extern double OnePasswordExtensionVersionNumber;
	//	[Field("OnePasswordExtensionVersionNumber", "__Internal")]
	//	double OnePasswordExtensionVersionNumber { get; }

	//	// extern const unsigned char [] OnePasswordExtensionVersionString;
	//	[Field("OnePasswordExtensionVersionString", "__Internal")]
	//	NSString OnePasswordExtensionVersionString { get; }
	//}
}